...
protected:
	...
	UFUNCTION()
		void OnSpehereEndOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp,
	...
	// Called when ItenInterpTimer is finished
	void FinishInterping();

	// Handles Item interpolation when in the EquippedInterping state
...
public:
	...
	// Called in AShooterChracter::GetPickupItem
...
public:
	...
	// Set item icon for the invetory
