...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FEquipItemDelegate, int32, CurrenSlotIndex, int32, NewSlotIndex);
...
public:
	...
	virtual float TakeDamage(float DamageAmount, struct FDamageEvent const& DamageEvent,
		class AController* EventInvestigator, AActor* DamageCauser) override;
...
protected:
	...
	// Set BaseTurnRate an BaseLookUpRate based on aiming
	void setLookRates();
...
private:
	...
	// True when we can fire. False when waitin for the timer
	bool bShouldFire;
	...
	// Hit react anim montage; for when Chracter is stunned
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
